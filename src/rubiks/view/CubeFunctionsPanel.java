...
public class CubeFunctionsPanel extends JPanel
{
	...
	private void setupPanel()
	{
		...
		solve.setText("Solve");
		solve.setFont(new Font("Lucida Grande", Font.PLAIN, 42));
